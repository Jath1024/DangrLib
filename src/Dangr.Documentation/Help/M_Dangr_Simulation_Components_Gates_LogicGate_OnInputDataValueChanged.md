# LogicGate.OnInputDataValueChanged Method 
 

\[Missing <summary> documentation for "M:Dangr.Simulation.Components.Gates.LogicGate.OnInputDataValueChanged(System.Object,Dangr.Simulation.Types.DataValueChangedEventArgs)"\]
...
**C#**<br />
``` C#
protected abstract void OnInputDataValueChanged(
	Object sender,
...
**VB**<br />
``` VB
Protected MustOverride Sub OnInputDataValueChanged ( 
	sender As Object,
