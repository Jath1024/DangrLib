# InverseQuadraticAnimator Class<a href="T_Dangr_Math_Animator">Animator</a> that animates using the equation: V = 1 - (T - 1) ^ 2 Starts out fast, slows down to the end.
