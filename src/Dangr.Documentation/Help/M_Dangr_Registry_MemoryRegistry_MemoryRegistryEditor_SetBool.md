# MemoryRegistry.MemoryRegistryEditor.SetBool Method 
 

Set a bool value to be written to the <a href="T_Dangr_Registry_IRegistry">IRegistry</a> after <a href="M_Dangr_Registry_MemoryRegistry_MemoryRegistryEditor_Apply">Apply()</a>.
...
**C#**<br />
``` C#
public IRegistryEditor SetBool(
	string key,
	bool value
)
```
...
``` C++
public:
virtual IRegistryEditor^ SetBool(
	String^ key, 
	bool value
) sealed
```
...
#### Implements
<a href="M_Dangr_Registry_IRegistryEditor_SetBool">IRegistryEditor.SetBool(String, Boolean)</a><br />
