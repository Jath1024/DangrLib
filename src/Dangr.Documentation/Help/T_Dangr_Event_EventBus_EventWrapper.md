# EventBus.EventWrapper Class
 

\[Missing <summary> documentation for "T:Dangr.Event.EventBus.EventWrapper"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Dangr.Event.EventBus.EventWrapper<br />
...
**C++**<br />
``` C++
private ref class EventWrapper
```

The EventBus.EventWrapper type exposes the following members.
...
<a href="#eventbus.eventwrapper-class">Back to Top</a>
