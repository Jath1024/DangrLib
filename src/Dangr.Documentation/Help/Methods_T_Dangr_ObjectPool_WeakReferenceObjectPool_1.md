# WeakReferenceObjectPool(*T*) Methods
 

The <a href="T_Dangr_ObjectPool_WeakReferenceObjectPool_1">WeakReferenceObjectPool(T)</a> generic type exposes the following members.
...
<a href="#weakreferenceobjectpool(*t*)-methods">Back to Top</a>
