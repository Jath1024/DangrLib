# InjectionModuleAttribute Class
 

\[Missing <summary> documentation for "T:Dangr.Inject.InjectionModuleAttribute"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/e8kc3626" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Dangr.Inject.InjectionModuleAttribute<br />
...
**VB**<br />
``` VB
Public Class InjectionModuleAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class InjectionModuleAttribute : public Attribute
```

The InjectionModuleAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Inject_InjectionModuleAttribute__ctor">InjectionModuleAttribute</a></td><td>
Initializes a new instance of the InjectionModuleAttribute class</td></tr></table>&nbsp;
<a href="#injectionmoduleattribute-class">Back to Top</a>
