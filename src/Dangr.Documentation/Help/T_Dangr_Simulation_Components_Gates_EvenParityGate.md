# EvenParityGate Class
 

\[Missing <summary> documentation for "T:Dangr.Simulation.Components.Gates.EvenParityGate"\]
...
**VB**<br />
``` VB
Public Class EvenParityGate
	Inherits LogicGate
```

**C++**<br />
``` C++
public ref class EvenParityGate : public LogicGate
```

The EvenParityGate type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Simulation_Components_Gates_EvenParityGate__ctor">EvenParityGate</a></td><td>
Initializes a new instance of the EvenParityGate class</td></tr></table>&nbsp;
<a href="#evenparitygate-class">Back to Top</a>
