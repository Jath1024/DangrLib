# LinearAnimator Class<a href="T_Dangr_Math_Animator">Animator</a> that animates using the equation: V = T Constant speed throughout.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_Dangr_Math_Animator">Dangr.Math.Animator</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Dangr.Math.LinearAnimator<br />
...
**C++**<br />
``` C++
public ref class LinearAnimator : public Animator
```

The LinearAnimator type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Math_LinearAnimator__ctor">LinearAnimator</a></td><td>
Initializes a new instance of the LinearAnimator class.</td></tr></table>&nbsp;
<a href="#linearanimator-class">Back to Top</a>
...
## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Dangr_Math_LinearAnimator_CalculateScale">CalculateScale</a></td><td>
