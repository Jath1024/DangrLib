# WriteConnection.DataBitWidth Property 
 

Gets the number of data bits in the <a href="T_Dangr_Simulation_Connections_IConnection">IConnection</a> .
...
``` C++
public:
virtual property int DataBitWidth {
	int get () sealed;
}
```
...
#### Implements
<a href="P_Dangr_Simulation_Connections_IConnection_DataBitWidth">IConnection.DataBitWidth</a><br />
