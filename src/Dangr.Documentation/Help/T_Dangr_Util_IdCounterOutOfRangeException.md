# IdCounterOutOfRangeException Class
 

Exception thrown when an <a href="T_Dangr_Util_IdCounter">IdCounter</a> attempts to get an ID outside of its specified range.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Dangr.Util.IdCounterOutOfRangeException<br />
...
``` VB
<SerializableAttribute>
Public Class IdCounterOutOfRangeException
	Inherits Exception
```
...
``` C++
[SerializableAttribute]
public ref class IdCounterOutOfRangeException : public Exception
```

The IdCounterOutOfRangeException type exposes the following members.
...
Initializes a new instance of the IdCounterOutOfRangeException class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Util_IdCounterOutOfRangeException__ctor_1">IdCounterOutOfRangeException(UInt64, UInt64, UInt64)</a></td><td>
Initializes a new instance of the IdCounterOutOfRangeException class.</td></tr></table>&nbsp;
<a href="#idcounteroutofrangeexception-class">Back to Top</a>
