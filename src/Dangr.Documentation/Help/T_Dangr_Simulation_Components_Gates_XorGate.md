...
\[Missing <summary> documentation for "T:Dangr.Simulation.Components.Gates.XorGate"\]
...
**C++**<br />
``` C++
public ref class XorGate : public LogicGate
```

The XorGate type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Simulation_Components_Gates_XorGate__ctor">XorGate</a></td><td>
Initializes a new instance of the XorGate class</td></tr></table>&nbsp;
<a href="#xorgate-class">Back to Top</a>
