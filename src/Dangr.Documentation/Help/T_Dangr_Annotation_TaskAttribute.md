...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/e8kc3626" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Dangr.Annotation.TaskAttribute<br />
...
``` VB
<AttributeUsageAttribute(AttributeTargets.All, Inherited := false, AllowMultiple := true)>
Public NotInheritable Class TaskAttribute
	Inherits Attribute
```
...
``` C++
[AttributeUsageAttribute(AttributeTargets::All, Inherited = false, AllowMultiple = true)]
public ref class TaskAttribute sealed : public Attribute
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Annotation_TaskAttribute__ctor">TaskAttribute</a></td><td>
Initializes a new instance of the TaskAttribute class.</td></tr></table>&nbsp;
<a href="#taskattribute-class">Back to Top</a>
