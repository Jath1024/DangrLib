...
\[Missing <summary> documentation for "T:Dangr.Simulation.Components.Gates.AndGate"\]
...
**C++**<br />
``` C++
public ref class AndGate : public LogicGate
```

The AndGate type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Dangr_Simulation_Components_Gates_AndGate__ctor">AndGate</a></td><td>
Initializes a new instance of the AndGate class</td></tr></table>&nbsp;
<a href="#andgate-class">Back to Top</a>
