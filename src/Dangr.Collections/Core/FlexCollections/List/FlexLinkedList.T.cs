// -----------------------------------------------------------------------
//  <copyright file="FlexLinkedList.T.cs" company="Phoenix Game Studios, LLC">
...
namespace Dangr.Core.FlexCollections.List
{
    ...
    /// <summary>
    /// A generic implementation of a <see cref="FlexLinkedList"/>.
    /// </summary>
    /// <typeparam name="T">The type of objects contained in the FlexList.</typeparam>
    /// <seealso cref="Dangr.Core.FlexCollections.List.FlexLinkedList.IGeneric{T}" />
    public class FlexLinkedList<T> : FlexLinkedList.IGeneric<T>
    {
        ...
        public FlexLinkedList()
        {
        }

        public FlexLinkedList(IEnumerable<T> items)
        {
            this.AddAll(items);
        }
        ...
        public void Set(int index, T value)
        {
            ...
            if (index == 0)
            {
                this.head = this.ReplaceNode(null, this.head, value);
            }
            else
            {
                LinkedListNode prevNode = this.GetNodeAt(index - 1);
                this.ReplaceNode(prevNode, prevNode.Next, value);
            }
        }
        ...
        /// </summary>
        /// <param name="prevNode">The node before the node to be replaced. Can be null.</param>
        /// <param name="oldNode">The old node to replace.</param>
        /// <param name="newValue">The new value.</param>
        /// <returns>The newly created node.</returns>
        private LinkedListNode ReplaceNode(LinkedListNode prevNode, LinkedListNode oldNode, T newValue)
        {
            LinkedListNode newNode = this.AppendNode(prevNode, newValue);
        ...
        /// <summary>
        /// Enumerator for a FlexLinkedList instance.
        /// </summary>
        /// <seealso cref="Dangr.Core.FlexCollections.List.FlexLinkedList.IGeneric{T}" />
