// -----------------------------------------------------------------------
//  <copyright file="FlexLinkedListMultiMap.cs" company="Phoenix Game Studios, LLC">
...
{
    public static class FlexLinkedListMultiMap
    {
        /// <summary>
        ...
        public interface IReadOnlyCovariant<out TKey, out TValue>
            : FlexListMultiMap.IReadOnlyCovariant<TKey, TValue>
        {
        }
        ...
        public interface IReadOnly<TKey, TValue>
            : IReadOnlyCovariant<TKey, TValue>, FlexListMultiMap.IReadOnly<TKey, TValue>
        {
        }
        ...
        public interface ICovariant<out TKey, out TValue>
            : IReadOnlyCovariant<TKey, TValue>, FlexListMultiMap.ICovariant<TKey, TValue>
        {
        }
        ...
        public interface IGeneric<TKey, TValue>
            : IReadOnly<TKey, TValue>, ICovariant<TKey, TValue>, FlexListMultiMap.IGeneric<TKey, TValue>
        {
        }
    }
}