// -----------------------------------------------------------------------
//  <copyright file="FlexHashBiMap.cs" company="Phoenix Game Studios, LLC">
...
namespace Dangr.Core.FlexCollections.BiMap
{
    ...
    public static class FlexHashBiMap
    {
        /// <summary>
        ...
        public interface IReadOnlyCovariant<out TKey, out TValue> : FlexBiMap.IReadOnlyCovariant<TKey, TValue>,
            FlexHashMap.IReadOnlyCovariant<TKey, TValue>
        {
        }
        ...
        public interface IReadOnly<TKey, TValue> : IReadOnlyCovariant<TKey, TValue>,
            FlexBiMap.IReadOnly<TKey, TValue>,
            FlexHashMap.IReadOnly<TKey, TValue>
        {
        }
        ...
        public interface ICovariant<out TKey, out TValue> : IReadOnlyCovariant<TKey, TValue>,
            FlexBiMap.ICovariant<TKey, TValue>,
            FlexHashMap.ICovariant<TKey, TValue>
        {
        }
        ...
        public interface IGeneric<TKey, TValue> : IReadOnly<TKey, TValue>,
            ...
            FlexBiMap.IGeneric<TKey, TValue>,
            FlexHashMap.IGeneric<TKey, TValue>
        {
        }
    }
}