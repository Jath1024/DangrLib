// -----------------------------------------------------------------------
//  <copyright file="InvalidCommandArgumentException.cs" company="Phoenix Game Studios, LLC">
...
namespace Dangr.Core.Command.Exceptions
{
    ...
    /// <summary>
    /// The Exception that is thrown when an invalid value is given for a command argument.
    /// </summary>
    ...
    public class InvalidCommandArgumentException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidCommandArgumentException"/> class.
        /// </summary>
        /// <param name="argumentName">Name of the invalid argument.</param>
        /// <param name="message">The message.</param>
        public InvalidCommandArgumentException(string argumentName, string message) : base(message)
        {
